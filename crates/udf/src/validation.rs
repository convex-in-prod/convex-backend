...
impl ValidatedPathAndArgs {
    ...
    pub fn from_proto(
        ...
        let udf_path = path.context("Missing udf_path")?.parse()?;
...
impl TryFrom<ValidatedPathAndArgs> for pb::common::ValidatedPathAndArgs {
    ...
    fn try_from(
        ...
        Ok(Self {
            ...
            context_reuse: Some(context_reuse.into()),
        })
    }
}

impl From<ContextReusePolicy> for pb::common::ContextReusePolicy {
    fn from(policy: ContextReusePolicy) -> Self {
        Self {
...
impl TryFrom<pb::common::ContextReusePolicy> for ContextReusePolicy {
    type Error = anyhow::Error;

    fn try_from(policy: pb::common::ContextReusePolicy) -> anyhow::Result<Self> {
        Ok(Self {
